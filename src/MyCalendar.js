...
const MyCalendar = () => {
  ...
  return (
    <div className="calendar-container">
      ...
      {isModalOpen && (
        <Modal
          visible={isModalOpen} // Set the visibility of the modal
          onCancel={() => setModalOpen(false)} // Function to handle modal close
          footer={null} // Hide the footer of the modal
        >
          {/* Modal content */}
          <div className="modal">
              ...
              <ul>
                {slotsForSelectedDate.map((slot, index) => (
                  <li key={index}>
                    ...
                    <button className='delete-btn' onClick={() => handleDeleteSlot(index)}> <img src={require('./Delete.png')} alt="" /> </button>
                  </li>
                ))}
              </ul>
              <div>
